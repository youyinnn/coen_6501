...
For non-pipelining circuit, the \(end\_flag\) will result in the output a clock later after the \textquote{load} signal goes from high to low.
...
\begin{figure}[!ht]
	...
	\subfloat[2 Stage End Flag Generator]{\includegraphics[width=0.3\textwidth]{./img/asmd_2.png}}
	\hspace{1cm}
	\subfloat[4 Stage End Flag Generator]{\includegraphics[width=0.6\textwidth]{./img/asmd.png}}
